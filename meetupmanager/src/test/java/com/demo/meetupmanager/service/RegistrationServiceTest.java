...
public class RegistrationServiceTest {
    ...
    public void saveRegistration() {
        ...
        assertThat(savedRegistration.getName()).isEqualTo("henrique p");
        assertThat(savedRegistration.getDateOfRegistration()).isEqualTo("01/01/2000");
        assertThat(savedRegistration.getRegistration()).isEqualTo("001");

    }

    private Registration createValidRegistration() {
        return Registration.builder().id(101).name("henrique p").dateOfRegistration("01/01/2000").registration("001").build();
    }
